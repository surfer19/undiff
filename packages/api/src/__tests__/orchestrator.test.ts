...
const fakeEnv = {
  ...
  AI_OPTIONS_MODEL: 'claude-3-5-haiku-latest',
  AI_BRANCH_MODEL: 'claude-3-5-haiku-latest',
  AI_OPTIONS_MAX_INPUT_CHARS: 12000,
  AI_OPTIONS_MAX_TOKENS: 900,
  AI_BRANCH_MAX_TOKENS: 1200,
